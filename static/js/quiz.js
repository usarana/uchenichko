...
[
    [
        'Променяме знака и става $9$', 
        'Променяме знака и става $-18$', 
        '$21:7+30.3 = 3+90 = +93$', 
        'Тук всички числа са отрицателни', 
        '$(x-23):8=|-9|$<br>$x-23=8.|-9|$<br>$x-23=72$<br>$x=95$'
    ],
    [
        '$-8+8$, различни знаци, следователно $0$', 
        '$-9-3=-12$', 
        '$4-8=-4$', 
        '$-8+2-4=-6-4=-10$', 
        '$13{,}2-18{,}4-9=-5{,}2-9=-14{,}2$'
    ],
    [
        '- и - прави +', 
        '+ и - прави -', 
    ...
    [
        '$S_{фиг}=S_{усп}+S_{\\Delta}=(4.2)+(\\frac{4.3}{2})=8+6=14$', 
        '$S_{фиг}=AB^2=6^2=36$', 
        '$S_{фиг}=\\frac{AB.BC}{2}=\\frac{7.4}{2}=14$', 
        '$C(4; 0), D(0; 3).$<br>$S=\\frac{4.3}{2} + \\frac{4.3}{2} = 12+12 = 24$', 
        '$B(4; -3), C(4; 3), D(-4; 3).$<br>$S=8.6=48$'
    ],
    [
        'Използваме правилото. $7^{15-13}=7^2=49$', 
        'Използваме правилото. $2^{2+3}=2^5=32$', 
        'Използваме правилото. $2^{7+3}:2^{10}=2^{10}:2^{10}=1$', 
        'Използваме правилото. $3^{8-3}=3^5=243$', 
        'Използваме правилото. $a^{10}.a^{21}=a^{10+21}=a^{31}$'
    ],
    [
        'Използваме правилото $(a.b)^n=a^n.b^n$', 
        'Използваме правилото $(a:b)^n=a^n:b^n$', 
        'Използваме правилото $(a^n)^m=a^{n.m}$', 
        '$3^5.c^5=(3c)^5$', 
        '$(7^8)^5=7^{8.5}=7^{40}$'
    ],
    [
        'Използваме правилото $a^0=1$', 
        'Използваме правилото $a^{-n}=\\frac{1}{a^{n}}$', 
        'Използваме правилото $a^{-n}=\\frac{1}{a^{n}}$', 
        'Използваме правилото $a^{-n}=\\frac{1}{a^{n}}$', 
        'Използваме правилото $a^{-n}=\\frac{1}{a^{n}}$'
    ],
    ...
    [
        '$x=-{\\frac{b}{a}}=-\\frac{-20}{4}=-(-5)=5$', 
        '$x=-{\\frac{b}{a}}=-\\frac{15}{-3}=-(-5)=5$', 
        '$x=-{\\frac{b}{a}}=-\\frac{-2}{\\frac{1}{3}}=-(-6)=6$', 
        '$-72:(-9)=8$', 
        '$-43{,}2:3{,}6=-12$'
    ],
    [
        '$4x-5=-17$<br>$4x=-12$<br>$x=-3$', 
        '$5x+9=2x-6$<br>$5x+15=2x$<br>$3x+15=0$<br>$3x=-15$<br>$x=-5$', 
        '$5x-10-5=3x+9-2x$<br>$5x-15=x+9$<br>$5x=x+24$<br>$4x=24$<br>$x=6$', 
        '$7.x-2.(x+1{,}5)=5.(x-1{,}4)-3.(x+\\frac{2}{3})$<br>$7.x-2.x-3=5.x-7-3.x-2$<br>$5.x-3=2.x-9$<br>$3.x=-6$<br>$x=-2$', 
        '$6.(x-3)-2.(x+4)=7.(x+1)-5.(x+3)$<br>$6.x-18-2.x-8=7.x+7-5.x-15$<br>$4.x-26=2.x-8$<br>$2.x=18$<br>$x=9$'
    ],
    [
        'Количество ($x$) - 1 kg, цена ($y$) - 3,00 лв.<br>$y = kx$<br>$3 = 1k$<br>$k=3$<br>$y=3x$', 
        'Количество ($x$) - 6 kg, цена ($y$) - 7,20 лв.<br>$y=kx$<br>$7{,}20=6k$<br>$k=1{,}20$<br>$y=kx=1{,}20.1=1{,}20$', 
        'Намираме периметър на равностранен триъгълник като съберем три пъти страната $a$, следователно отговора е $P_{\\Delta}=3a$', 
        'Намираме периметър на квадрат като съберем четири пъти страната $a$, следователно отговора е $P_{\\square}=4a$', 
        'Количество ($x$) - 6 kg, цена ($y$) - 9,30 лв.<br>$y = kx$<br>$9{,}30 = 6k$<br>$k=1{,}55$<br>$y=kx$=$1{,}55.2$=$3{,}10$'
    ],
    [
        '$15x=3.5$<br>$15x=15$<br>$x=1$', 
        '$7{,}3.0,4=2x$<br>$2{,}92=2x$<br>$x=1{,}46$', 
        '$a=3b$<br>$b:a=b:(3b)=1:3$', 
        'Виждаме че $b$ е по-малко, следователно отговора е $13:4$', 
        'Виждаме че $3.16=48$, следователно намираме неизвестният член като делим 48 на 2'
    ]
]
const explanationsBulg = 
[
    [
        'Другите изрази се отнасят за български език, математика, история и биология', 
        'Казано в урока', 
        'Казано в урока', 
        'Казано в урока', 
        'Казано в урока'
    ...
    [
        'тези - показателно местоимение, близки лица, мн.ч.', 
        'такива - показателно местоимение, признаци, мн.ч.', 
        'толкова - показателно местоимение, количество', 
        'Казано в урока', 
        'Казано в урока'
    ],
    [
        'колко - въпросително местоимение, количество', 
        'какви - въпросително местоимение, признаци, мн.ч.', 
        '"Кой" се използва само когато е подлог. "Кого" се използва в другите случаи.', 
        'Казано в урока', 
        'Казано в урока'
    ],
    [
        'никой, никакъв, ничий, николко, ...', 
        'Таблицата от урока', 
        'никаква - отрицателно местоимение за признаци, ж.р.', 
        'Казано в урока', 
        'Казано в урока'],
    [
        'всички - за лица, мн.ч.', 
        'всякой - лица, всякакво - признаци, всичко - предмети', 
        'всякакъв - признаци, мъжки род', 
        'Казано в урока', 
        'Казано в урока'
    ],
    [
        'някой - лица, мъжки род', 
        'някой - лица, някакъв - признаци, нещо - предмети', 
        'нечий - притежание, мъжки род', 
        'Казано в урока', 
        'Казано в урока'
    ],
    [
        'който, какъвто, чийто, колкото, ...', 
        'чийто - принадлежност, колкото - количество, който - лица', 
        'колкото - количество', 
        'Казано в урока', 
        'Казано в урока'
    ]
