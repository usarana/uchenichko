...
[
    ...
    ['$x=-{\\frac{b}{a}}=-\\frac{-20}{4}=-(-5)=5$', '$x=-{\\frac{b}{a}}=-\\frac{15}{-3}=-(-5)=5$', '$x=-{\\frac{b}{a}}=-\\frac{-2}{\\frac{1}{3}}=-(-6)=6$', '$-72:(-9)=8$', '$-43{,}2:3{,}6=-12$'],
    ['$4x-5=-17$<br>$4x=-12$<br>$x=-3$', '$5x+9=2x-6$<br>$5x+15=2x$<br>$3x+15=0$<br>$3x=-15$<br>$x=-5$', '$5x-10-5=3x+9-2x$<br>$5x-15=x+9$<br>$5x=x+24$<br>$4x=24$<br>$x=6$', '$7.x-2.(x+1{,}5)=5.(x-1{,}4)-3.(x+\\frac{2}{3})$<br>$7.x-2.x-3=5.x-7-3.x-2$<br>$5.x-3=2.x-9$<br>$3.x=-6$<br>$x=-2$', '$6.(x-3)-2.(x+4)=7.(x+1)-5.(x+3)$<br>$6.x-18-2.x-8=7.x+7-5.x-15$<br>$4.x-26=2.x-8$<br>$2.x=18$<br>$x=9$'],
    ['Количество ($x$) - 1 kg, цена ($y$) - 3,00 лв.<br>$y = kx$<br>$3 = 1k$<br>$k=3$<br>$y=3x$', 'Количество ($x$) - 6 kg, цена ($y$) - 7,20 лв.<br>$y=kx$<br>$7{,}20=6k$<br>$k=1{,}20$<br>$y=kx=1{,}20.1=1{,}20$', 'Намираме периметър на равностранен триъгълник като съберем три пъти страната $a$, следователно отговора е $P_{\\Delta}=3a$', 'Намираме периметър на квадрат като съберем четири пъти страната $a$, следователно отговора е $P_{\\square}=4a$', 'Количество ($x$) - 6 kg, цена ($y$) - 9,30 лв.<br>$y = kx$<br>$9{,}30 = 6k$<br>$k=1{,}55$<br>$y=kx$=$1{,}55.2$=$3{,}10$'],
    ['$15x=3.5$<br>$15x=15$<br>$x=1$', '$7{,}3.0,4=2x$<br>$2{,}92=2x$<br>$x=1{,}46$', '$a=3b$<br>$b:a=b:(3b)=1:3$', 'Виждаме че $b$ е по-малко, следователно отговора е $13:4$', 'Виждаме че $3.16=48$, следователно намираме неизвестният член като делим 48 на 2']
]
