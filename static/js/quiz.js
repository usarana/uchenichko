...
[
    ['Положителното число на $-9$ е $9$', 'Променяме знака и става $-18$', '$21:7+30.3 = 3+90 = +93$'],
    ['$-8+8$, различни знаци, следователно $0$', '$-9-3=-12$', '$4-8=-4$'],
    ['- и - прави +', '+ и - прави -', '- и - прави +, $7+10=17$'],
    ['$S_{фиг}=S_{усп}+S_{\\Delta}=(4.2)+(\\frac{4.3}{2})=8+6=14$', '$S_{фиг}=AB^2=6^2=36$', '$S_{фиг}=\\frac{AB.BC}{2}=\\frac{7.4}{2}=14$'],
    ['Използваме правилото. $7^{15-13}=7^2=49$', 'Използваме правилото. $2^{2+3}=2^5=32$', 'Използваме правилото. $2^{7+3}:2^{10}=2^{10}:2^{10}=1$'],
    ['Използваме правилото $(a.b)^n=a^n.b^n$', 'Използваме правилото $(a:b)^n=a^n:b^n$', 'Използваме правилото $(a^n)^m=a^{n.m}$'],
    ['Използваме правилото $a^0=1$', 'Използваме правилото $a^{-n}=\\frac{1}{a^{n}}$', 'Използваме правилото $a^{-n}=\\frac{1}{a^{n}}$'],
    ['$10000=10^4$', '$5.10^3=5.1000=5000$', '$37000=3,7.10^4$'],
...
[
    ...
    ['всички - за лица, мн.ч.', 'всякой - лица, всякакво - признаци, всичко - предмети', 'всякакъв - признаци, мъжки род'],
    ['някой - лица, мъжки род', 'някой - лица, някакъв - признаци, нещо - предмети', 'нечий - притежание, мъжки род'],
    ['който, какъвто, чийто, колкото, ...', 'чийто - принадлежност, колкото - количество, който - лица', 'колкото - количество']
]
