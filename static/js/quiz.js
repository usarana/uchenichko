...
const answersMath = [['b', 'c', 'd'], ['b', 'b', 'a'], ['d', 'c', 'a'], ['c', 'd', 'd'], ['b', 'd', 'a'], ['a', 'd', 'b'], ['d', 'a', 'd'], ['c', 'd', 'a'], ['c', 'a', 'b']]
const answersBulg = [['b', 'c', 'c'], ['', '', ''], ['d', 'd', 'a'], ['c', 'b', 'd'], ['b', 'b', 'a'], ['c', 'b', 'a']]
...
[
    ...
    ['$S_{фиг}=S_{усп}+S_{тр}=(8.2)+((4.3):2)=8+6=14$', '$S_{фиг}=AB^2=6^2=36$', '$S_{фиг}=(AB.BC):2=(7.4):2=14$'],
